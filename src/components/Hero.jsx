  ...
  <div className="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
      <img
        ...
        alt="hero"
        src="https://us.123rf.com/450wm/klavapuk/klavapuk1708/klavapuk170800054/84632249-traditional-symbols-of-india-in-the-form-of-a-stilized-map.jpg?ver=6"
      />
    </div>
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
        Cleaner India For A Better Tomorrow
      </h1>
      <p className="mb-8 leading-relaxed">
      Effective waste management and cleanliness are crucial for India's sustainable development. Proper waste disposal prevents environmental pollution, promotes public health, and enhances the quality of life, paving the way for a cleaner, healthier, and more prosperous nation.
      </p>
